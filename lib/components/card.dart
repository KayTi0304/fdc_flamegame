...
import 'package:fdc_kay/klondike_game.dart';
import 'package:fdc_kay/rank.dart';
import 'package:fdc_kay/suit.dart';
...
class Card extends PositionComponent {
  ...
  static late final Sprite redJack = klondikeSprite(81, 256, 562, 488);
  ...
  static final blueFilter = Paint()
    ..colorFilter =
        const ColorFilter.mode(Color(0x880d8bff), BlendMode.srcATop);
  static late final Sprite blackJack = klondikeSprite(81, 256, 562, 488);
  ...
  void _drawSprite(
      ...
      {double scale = 1, bool rotate = false}) {
    if (rotate) {
      canvas.save();
